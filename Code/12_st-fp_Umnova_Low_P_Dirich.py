...
probIdStr = 'st-fp-UmnovaLow-P-clean' # Identification of the problem for save files' names
...
def compute(Nele, dt, T_init, T_final, savePrefix=''):
    ...
    speakerOsc = Expression('(t-t0)*exp(-0.5*pow(w*(t-t0),2)+C)', a=1, w=50, t=0., t0=0.1, C=0, degree=6)
