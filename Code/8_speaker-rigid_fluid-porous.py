...
probIdStr = 'sr-fp' # Identification of the problem for save files' names
...
porous_domain = CompiledSubDomain("x[0] >= Li0", Li0=Li0) # At further end
...
def compute(Nele, dt, T_init, T_final, initCondId = 6, savePrefix=''):
    ...
    zero = Constant("0.0")
    harmOscilator = Expression('cos(omega*t)', omega=omega_fluid, t=0., degree=1)
    ...
    # bc_speaker = DirichletBC(V, harmOscilator, boundary_markers, 1)
    bc_speaker = DirichletBC(V, zero, boundary_markers, 1)
