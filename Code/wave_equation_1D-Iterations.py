...
def computeAbsError(approximateSol, exactSol):
...
for Nele in [50, 100, 150, 200, 250, 300]:
    for dt in [1E-04, 7.5E-05, 5E-05, 3.5E-05, 2.5E-05, 1E-05, 5E-06, 2.5E-06]:
        ...
        error.vector().set_local(computeAbsError(displacement, solution))
